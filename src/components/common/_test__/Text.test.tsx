...
describe('Text 컴포넌트', () => {
  it('label(text), price, type이 올바르게 렌더링된다.', () => {
    render(<Text text="보유잔액" price="1,000,000" type="KRW" size="sm" priceColor="black" />);
  ...
  describe('Price Color Style', () => {
    it('priceColor가 blue인 경우, price가 파란색으로 렌더링된다.', () => {
      render(<Text text="보유잔액" price="1,000,000" type="KRW" size="sm" priceColor="blue" />);
      expect(screen.getByText('1,000,000')).toHaveClass('text-sm text-[#0062DF]');
    });

    it('priceColor가 red인 경우, price가 빨간색으로 렌더링된다.', () => {
      render(<Text text="보유잔액" price="1,000,000" type="KRW" size="sm" priceColor="red" />);
  ...
  describe('Size Style', () => {
    it('size가 xs인 경우, price가 13px로 렌더링된다.', () => {
      render(<Text text="보유잔액" price="1,000,000" type="KRW" size="xs" priceColor="black" />);
  ...
  describe('price 형식 테스트', () => {
    it('price가 숫자인 경우, price가 올바르게 렌더링된다.', () => {
      render(<Text text="보유잔액" price={1000000} type="KRW" size="sm" priceColor="black" />);
