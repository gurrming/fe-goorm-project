      ...
      <table className="w-full border-collapse bg-white">
        <thead>
          <tr className="border-b border-t border-gray-200 bg-[#F7F7F7]">
            <th className="px-4 py-3 text-center text-[11px] font-medium text-[#333333] border-r border-gray-200">
              주문시간
            </th>
            <th className="px-4 py-3 text-center text-[11px] font-medium text-[#333333] border-r border-gray-200">
              구분
            ...
            <th className="px-4 py-3 text-center text-[11px] font-medium text-[#333333] border-r border-gray-200">
              <div className="flex flex-col">
                <span>감시가격</span>
                <span className="text-[11px] font-normal text-[#333333] mt-1">주문금액</span>
              </div>
            </th>
            <th className="px-4 py-3 text-center text-[11px] font-medium text-[#333333] border-r border-gray-200">
              <div className="flex flex-col">
                <span>주문량</span>
                <span className="text-[11px] font-normal text-[#333333] mt-1">미체결량</span>
              </div>
            </th>
            <th className="px-4 py-3 text-center text-[11px] font-medium text-[#333333] ">주문취소</th>
          </tr>
        </thead>
        <tbody>
