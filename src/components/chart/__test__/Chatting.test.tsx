...
describe('<Chatting /> 통합 테스트', () => {
    ...
    describe('예외 테스트', () => {
        ...
        it('C-13: 동일 사용자 다중 종목 메시지 발송 시 혼선 방지', async() => {
            ...
            (useChatting as Mock).mockReturnValue({
                chatHistory: [{ 
                    chatId: 1, chatContent: 'A 종목 메시지', chatTime: '2024-01-01T12:00:00', 
                    memberId: 1, memberNickname: '나', categoryId: 1 
                }],
                sendChat: sendChatMockA,
                isConnected: true
            });
            ...
            (useChatting as Mock).mockReturnValue({
                chatHistory: [{ 
                    chatId: 2, chatContent: 'B 종목 메시지', chatTime: '2024-01-01T12:05:00', 
                    memberId: 1, memberNickname: '나', categoryId: 2 
                }],
                sendChat: sendChatMockB,
                isConnected: true
            });
