    ...
    <div className="flex flex-col my-2">
      {/* <div className="flex gap-2 items-center bg-white px-4 border-b border-gray-200 text-[#333333]">
        ...
        <div className="w-[50%] flex gap-2 justify-between items-center ">
          <p className={`w-full text-sm font-bold text-center py-3 border-b-[3px] border-[#0062DF]`}>시세</p>
          <p className={`w-full text-sm font-bold text-center py-3`}>커뮤니티</p>
        </div>
      </div> */}
      <div className="flex items-center bg-white">
        <div className="flex flex-col px-4 w-1/2">
          ...
          <div className="flex items-center gap-3">
            <p className={`text-sm text-[#DD3C44]`}>{0}%</p>
            <p className="text-sm text-[#DD3C44]">${0}</p>
          </div>
        </div>
